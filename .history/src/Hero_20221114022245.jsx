...
const Hero = () => {
  return (
    <>
      ...
      <div className="bg-purpleBackground px-24 py-4 md:mb-20">
        {/* LOGO-LABEL */}
        <div className="flex flex-col space-y-8 items-center md:flex-row md:space-y-0 md:justify-between md:items-center">
