...
const Hero = () => {
  return (
    <section className="container mx-auto max-w-7xl px-6 mt-20">
      <div className="flex flex-col-reverse items-center space-y-4 md:flex-row md:space-y-0 md:space-x-8 md:justify-between">
        <div className="flex flex-col items-center space-y-8 md:max-w-1/2">
          ...
          <p className="text-lightBlack text-2xl text-center font-small md:text-left md:max-w-2xl">
