    ...
    <section className="container mx-auto max-w-7xl px-6 mt-20">
      <div className="flex flex-col-reverse space-y-4 md:flex-row md:space-y-0 md:space-x-8">
        <div className="flex flex-col space-y-8 md:max-w-1/2">
          ...
          <p className="text-lightBlack text-2xl font-small">
          ...
          <form action="flex w-full">
            <input
              type="text"
              class="flex-2 p-3 border-2 rounded-l-lg placeholder-greyColor focus:outline-none"
              placeholder="Search for location"
              id="link-input"
            />

            <button class="px-14 py-[14px] text-white bg-purpleBackground rounded-r-lg focus:outline-none">
              Search
            </button>
          </form>
        </div>
