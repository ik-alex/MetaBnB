...
const Hero = () => {
  return (
    <section className="container mx-auto max-w-7xl px-6 mt-40">
      <div className=" flex flex-col-reverse space-y-8 items-center md:flex-row md:space-y-0 md:space-x-8 md:justify-between">
