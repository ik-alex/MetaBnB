  ...
  return (
    <>
      ...
      <section className="bg-purpleBackground  p-6">
        <div className="mx-auto container text-white px-6 flex flex-col-reverse items-center justify space-y-4 md:flex-row md:space-y-0 ">
          <div className="flex flex-col space-y-8 mt-12 md:mt-0 md:w-1/2 md:justify-start">
            <h1>Metabnb NFTs</h1>
