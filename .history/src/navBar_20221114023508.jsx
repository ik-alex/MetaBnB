...
const NavBar = () => {
  return (
    <nav className="relative container mx-auto max-w-7xl p-6">
      {/* logo&content */}
      <div className="flex items-center justify-between">
        ...
        {/* nav menu */}
        <div className="hidden text-lightBlack text-xl font-medium space-x-12 lg:flex">
          <a
            href="#"
            className="leading-12 hover:from-purpleBackground hover:to-violetColor "
          >
            Home
          </a>
