...
const Hero = () => {
  return (
    <section className="container mx-auto max-w-7xl px-6 mt-20">
      <div className=" flex flex-col-reverse items-center md:flex-row md:space-y-0 md:justify-between">
        <div className="flex flex-col items-center space-y-8 md:items-start lg:max-w-1/2">
          ...
          <p className="text-lightBlack text-2xl font-small text-center md:text-left  md:max-w-md lg:max-w-2xl">
          ...
          <form action="">
            <input
              type="text"
              className="flex w-full flex-1 p-3 border-2 rounded-l-lg placeholder-greyColor focus:outline-none"
        ...
        <div className="flex flex-col md:flex-row lg  :max-w-1/2">
          <div className="">
