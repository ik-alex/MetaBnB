...
const Hero = () => {
  return (
    <>
      ...
      {/* metabnb NFTs */}
      <section className="bg-purpleBackground container mx-auto p-6">
        <div className="flex flex-col-reverse items-center space-y-4 md:flex-row md:space-y-0">
          <div className="flex flex-col space-y-4 md:max-w-1/2">
            <h1>Metabnb NFTs</h1>
            <p>
