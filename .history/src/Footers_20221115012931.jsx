    ...
    <footer className="bg-deepBlack p-6 ">
      <div className="mx-auto max-w-[90%] px-6 py-4 text-white">
        <div className="flex flex-col-reverse items-center space-y-4 md:flex-row md:space-y-0 md:space-x-12">
          <div className="flex flex-col space-y-16 items-center md:items-start md:w-1/4">
          ...
          <div className="flex flex-col space-y-4 md:flex-row md:space-y-0 md:justify-between md:md:w-3/4">
            <div className="">
              <h5 className="mb-4">Community</h5>
              <div className="flex flex-col space-y-4 flex-start">
                <a>NFT</a>
                <a>Tokens</a>
                <a>Landlords</a>
                <a>Discord</a>
