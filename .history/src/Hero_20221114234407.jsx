  ...
  return (
    <>
      ...
      <section className="bg-purpleBackground  p-6">
        <div className="mx-auto container text-white px-6 flex flex-col-reverse items-center space-y-4 md:flex-row md:space-y-0 ">
          <div className="flex flex-col items-center space-y-8 mt-12 md:mt-0 md:w-1/2 md:justify-start">
            <h1>Metabnb NFTs</h1>
            <p className="max-w-md md:max-w-xl">
          ...
          <div className=" md:w-1/2">
            <img src="/img/Frame59546.svg" alt="nfts" />
          </div>
        </div>
      </section>
    </>
