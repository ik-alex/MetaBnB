  ...
  return (
    <nav className="px-6 mt-10">
      <div className="container mx-auto flex  justify-between font-bold py-4">
        ...
        {/* nav menu */}
        <div className="flex items-center space-x-12 pt-2 leading-[24.98px] text-lightBlack font-medium">
        ...
        {/* connect wallet */}
        <button className="bg-purpleBackground rounded-md mt-1 px-6 py-2 text-white">
          Connect Wallet
        </button>
      </div>
    </nav>
