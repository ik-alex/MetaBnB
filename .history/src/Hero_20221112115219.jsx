      ...
      <div className="flex flex-col-reverse space-y-4 md:flex-row md:space-y-0 md:space-x-8">
        <div className="flex flex-col space-y-8 md:max-w-1/2">
          ...
          <form action="">
            <input
              type="text"
              class="flex-1 p-3 border-2 rounded-lg placeholder-greyColor focus:outline-none"
              placeholder="Search for location"
              id="link-input"
            />

            <button class="px-10 py-3 text-white bg-purpleBackground rounded-lg hover:bg-cyanLight focus:outline-none md:py-2">
              Search
            </button>
          </form>
        </div>
