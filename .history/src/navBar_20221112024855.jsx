...
const NavBar = () => {
  return (
    <nav className="px-12 mt-10">
      <div className="container max-w-2xl mx-auto flex items-center justify-between font-bold py-4">
        {/* logo&content */}
        ...
        {/* nav menu */}
        <div className="hidden text-lightBlack text-xl font-medium md:flex md:block md:items-center md:space-x-10">
