...
const Hero = () => {
  return (
    <>
      <Wallet />
      <section className="container mx-auto max-w-[90%] px-6 mr-tb">
        <div className=" flex flex-col-reverse items-center md:flex-row md:space-y-0 md:space-x-8 md:justify-between">
          <div className="flex flex-col items-center space-y-8 md:items-start md:max-w-1/2">
            <h2 className="text-4xl text-center text-lightBlack mt-16 font-medium capitalize max-w-2xl md:text-left md:max-w-md md:mt-0">
              rent a{" "}
            ...
            <div className="inputs">
              ...
              />
              <input className="absolute" type="submit" value="Search" />
            </div>
          </div>
      ...
      <section className="bg-purpleBackground  p-6">
        <div className=" container mx-auto max-w-[90%] text-white px-6 flex flex-col-reverse items-center space-y-4 md:flex-row md:space-y-0 ">
          ...
          <div className=" md:w-1/2">
            <img className="w-full" src="/img/Frame59546.svg" alt="nft" />
          </div>
        </div>
      </section>
    </>
